...
# Detección/normalización de modelos: ahora en equipment_detection (compartido
# con work_order_json). Se re-importan abajo las funciones que usa este módulo.
